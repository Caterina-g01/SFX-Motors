    ...
    <div className={`${s.contactsContainer} ${isVisible ? s.visible : ""}`}>
      <div className={s.contactsContactsSection}>
        <div className={s.contactsContacts}>
          ...
          <p className={s.contactsContactsNumber}> Номер в РБ :&nbsp;
            <a className={s.contactsContactsNumberLink} href="tel:+375293703366">+375 (29) 370-33-66</a>
          </p>
          <p className={s.contactsContactsNumber}> Номер в РФ :&nbsp;
            <a className={s.contactsContactsNumberLink}href="tel:+79938851003">+7 (993) 885-10-03</a>
          </p>
          </div>
